...
| <img src="./assets/readme/style-c-theme-cyan.png" width="420" alt="🌊 Cyan Tech theme preview"> | 🌊 **Cyan Tech** | ⚠️ The fine-tuning for this theme is not yet polished and feels rougher than the default Mint theme — **not recommended for production use yet**. `#006586` deep cyan ink. Tech sharing / data reporting / engineering presenting product architecture / B2B technical demos. |
| <img src="./assets/readme/style-c-theme-orange.png" width="420" alt="🌅 Warm Orange Proposal theme preview"> | 🌅 **Warm Orange Proposal** | ⚠️ The fine-tuning for this theme is not yet polished and feels rougher than the default Mint theme — **not recommended for production use yet**. `#FF7847` warm orange-vermilion. Sales proposals / growth reports / marketing campaign plans / customer case decks. |
| <img src="./assets/readme/style-c-theme-deep.png" width="420" alt="🌌 Deep Space Review theme preview"> | 🌌 **Deep Space Review** | ⚠️ The fine-tuning for this theme is not yet polished and feels rougher than the default Mint theme — **not recommended for production use yet**. `#1A2028` deep space blue-gray + `#00BFA5` mint accent. **The only dark-base theme** — promotion review / personal performance review / team retro / year-end summary. |
