...
| <img src="./assets/readme/style-c-theme-cyan.png" width="420" alt="🌊 青墨科技主题预览"> | 🌊 **青墨科技** | `#006586` 深青墨。技术分享 / 数据汇报 / 研发对外讲产品架构 / B 端技术 demo。 |
| <img src="./assets/readme/style-c-theme-orange.png" width="420" alt="🌅 暖橙提案主题预览"> | 🌅 **暖橙提案** | `#FF7847` 暖橙朱红。销售提案 / 增长汇报 / 营销活动方案 / 客户案例集。 |
| <img src="./assets/readme/style-c-theme-deep.png" width="420" alt="🌌 深空述职主题预览"> | 🌌 **深空述职** | `#1A2028` 深空蓝灰 + `#00BFA5` 薄荷点缀。**唯一一个默认 dark 主底**主题——职级评审 / 个人述职 / 团队复盘 / 年终总结。 |
